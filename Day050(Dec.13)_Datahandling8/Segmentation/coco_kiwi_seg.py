...
json_path = "./kiwi_poly/annotations/instances_default.json"
...
for image_info in coco_info["images"]:
    ...
    file_path = os.path.join("./kiwi_poly/images", filename)
    ...
    for bbox, segmentation, category in zip(annotation['boxes'], annotation['segmentation'],
    ...
    # cv2.imwrite(f"./kiwi_poly/{filename}", poly_img)
